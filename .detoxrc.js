...
module.exports = {
	...
	apps: {
		"ios.debug": {
			type: "ios.app",
			binaryPath:
				"/Users/itsector/Library/Developer/Xcode/DerivedData/mindeats-bgxqqticvctyezenmwxijgecetwy/Build/Products/Debug-iphonesimulator/mindeats.app",
			build: "npx expo run:ios --configuration Debug --no-bundler --no-install",
		},
		"ios.release": {
			type: "ios.app",
			binaryPath:
